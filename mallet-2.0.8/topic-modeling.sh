...
root_dir="/JSEA-path/JSEA/JSEA-store-data/"
...
./bin/mallet import-dir --input ${root_dir}/${input_dir_1}/${input_dir_2} --output ${root_dir}/${output_dir_1}/${output_file}.mallet --keep-sequence --remove-stopwords

...
public class ExtractHtmlContent {
    ...
    public ExtractHtmlContent(File inputFile, File outputFile, boolean ifGeneral, Map<String, Boolean> libraryTypeCondition, String copyrightInfoContent, String customizedPackageList, Map<String, Integer> documentWordsCountList) {
    ...
    public void extractHtmlContent() {
        ...
        try {
            try (
                ...
                ParseWords parseWordsTool = new ParseWords(extractResult, ifGeneral, libraryTypeCondition, copyrightInfoContent, customizedPackageList, documentWordsCountList, outputFile);
                extractResult = parseWordsTool.parseAllWords();
                writeWordsToFile(extractResult.toString(), outputFile);
            }
